...
#
# Script generated by Vivado on Tue Mar 03 23:49:37 IST 2026
...
#
# Usage        : Vi.sh
#                Vi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Vi.sh [-reset_run]
#                Vi.sh [-reset_log]
#                Vi.sh [-help]
#
...
#                script (type 'Vi.sh -help' for more information).
#
...
# script info
echo -e "Vi.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Vi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Vi xil_defaultlib.glbl -o Vi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Vi_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Vi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Vi_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Vi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Vi.sh [-help]\n\
Usage: Vi.sh [-step]\n\
Usage: Vi.sh [-lib_map_path]\n\
Usage: Vi.sh [-reset_run]\n\
Usage: Vi.sh [-reset_log]\n\
Usage: Vi.sh [-keep_index]\n\
Usage: Vi.sh [-noclean_files]\n\n\
