...
#
# Script generated by Vivado on Tue Feb 10 21:38:48 IST 2026
...
#
# Usage        : Z.sh
#                Z.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Z.sh [-reset_run]
#                Z.sh [-reset_log]
#                Z.sh [-help]
#
...
#                script (type 'Z.sh -help' for more information).
#
...
# script info
echo -e "Z.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Z.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Z xil_defaultlib.glbl -o Z_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Z_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Z_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Z_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Z.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Z.sh [-help]\n\
Usage: Z.sh [-step]\n\
Usage: Z.sh [-lib_map_path]\n\
Usage: Z.sh [-reset_run]\n\
Usage: Z.sh [-reset_log]\n\
Usage: Z.sh [-keep_index]\n\
Usage: Z.sh [-noclean_files]\n\n\
