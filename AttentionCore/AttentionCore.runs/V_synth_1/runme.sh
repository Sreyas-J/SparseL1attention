...
HD_PWD='/home/sk/Desktop/SparseL1Attention/AttentionCore/AttentionCore.runs/V_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log V.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source V.tcl
