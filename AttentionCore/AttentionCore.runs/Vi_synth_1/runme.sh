...
HD_PWD='/home/sk/Desktop/SparseL1Attention/AttentionCore/AttentionCore.runs/Vi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Vi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Vi.tcl
