...
HD_PWD='/home/sk/Desktop/SparseL1Attention/AttentionCore/AttentionCore.runs/K_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log K.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source K.tcl
