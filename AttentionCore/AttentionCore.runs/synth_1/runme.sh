...
HD_PWD='/home/sk/Desktop/SparseL1Attention/AttentionCore/AttentionCore.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AttentionCore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AttentionCore.tcl
